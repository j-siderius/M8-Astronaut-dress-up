...
class Errormessage:
    def __init__(self):
        ...
        self.textRect1.center = (self.screen_width // 2, self.screen_height // 5 + 40)
    ...
    def display(self):
        ...
        pygame.draw.rect(self.screen, self.WHITE,
                         ((self.screen_width / 20, height), (self.screen_width / 16, height * 12)))
        pygame.draw.rect(self.screen, self.WHITE, (
        (self.screen_width * 19 / 20 - self.screen_width / 16, height), (self.screen_width / 16, height * 12)))
        ...
        self.textRect2 = self.text2.get_rect(center=(self.screen_width // 2, self.screen_height // 2 + 20))
        self.textRect3 = self.text3.get_rect(center=(self.screen_width // 2, self.screen_height // 2 + 60))
